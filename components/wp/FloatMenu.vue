    ...
    <transition name="fade">
      ...
      >
        ...
        <div  class="p-2 text-white bg-orange-400 rounded-full cursor-pointer">
          <div @click="$parent.toggleShow('Setting')">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-5 h-5"
              viewBox="0 0 20 20"
        ...
        <div class="p-2 text-white rounded-full cursor-pointer bg-sky-400">
          <div @click="$parent.toggleShow('Map')">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-5 h-5"
              viewBox="0 0 20 20"
        ...
        <div v-if="hasPembanding" class="p-2 text-white bg-indigo-400 rounded-full cursor-pointer">
          <div @click="$parent.toggleShow('ExportImport')">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="w-5 h-5"
              fill="none"
